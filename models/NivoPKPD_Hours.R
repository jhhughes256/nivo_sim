...
AVCLH     = 0.06*24,      // clearance(L/h) at health status
...
double C1 =  CMT1/V1;
double C2 =  CMT2/V2;
dxdt_CMT1 = K21*CMT2-CMT1*K12-CMT1*K10 ;
...
//---SURVIVAL WEIBULL---
double HAZRATEBASE =  LAMBS*ALPHS*pow((SOLVERTIME/24+DEL),(ALPHS-1));
double HAZRATECOV  =  TUMSLD*TSHAZ + ECOG*ECOGHAZ;
dxdt_CMT4  = HAZRATEBASE*exp(HAZRATECOV+IIVHAZ);

//---DROPOUT WEIBULL---
dxdt_CMT5  = LAMBC*ALPHC*pow((SOLVERTIME/24+DEL),(ALPHC-1));
dxdt_CMT6  = CT;

...
population.data$GFR[population.data$SEX == 0]       <- cor.values[,3]*0.85    
population.data$GFR[population.data$SEX == 1]       <- cor.values[,3]
...
population.data <- subset(population.data, select=c(ID, SEX, BWT, AGE, GFR,ALB, ETA1, ETA2))
...
#   proportional dosage changes. Blood samples are only taken at three time
#   points to represent the reality of using TDM in clinical practice.
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
# Clear workspace
  rm(list=ls(all=TRUE))
  graphics.off()
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
  ...
  readr::write_rds(output_tdmstep_df, path = "output/stepwise_tdm_alt.rds")

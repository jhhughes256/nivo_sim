...
# Obtain population parameter variability for ninth ETA and allocate distribution
  ZTMAX <- omega.block[9, 9]  # ZHZ (variance) from model
  pop.data$ETA9 <- rnorm(n, mean = 0, sd = sqrt(ZTMAX))
